...
@Composable
fun PointerEvents() {
    var msg by remember { mutableStateOf("作者：蔡鈞如") }
    Column {
        Text("\n" + msg)
        Box(
            Modifier
...
fun Tap() {
    ...
    var PU = arrayListOf(R.drawable.pu0, R.drawable.pu1, R.drawable.pu2,
        R.drawable.pu3, R.drawable.pu4, R.drawable.pu5)
...
fun Drag_Vertical() {
    ...
    Text(
        text = "垂\n" + "直\n" + "拖\n" + "曳",
        modifier = Modifier
            .offset { IntOffset(1000, offsetY.toInt() + 80) }
            .draggable(
